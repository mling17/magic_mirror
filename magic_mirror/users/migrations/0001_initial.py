    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.TextField(default='', verbose_name='个人简介')),
                ('image', models.ImageField(default='image/default.png', upload_to='image/%Y/%m')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('uuid', models.CharField(default='', max_length=50, verbose_name='唯一标志符')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip', models.CharField(default='', max_length=50, verbose_name='登录ip')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='登录时间')),
